    ...
    private void styleChoiceButton(JButton button) {
        ...
        button.setUI(new javax.swing.plaf.basic.BasicButtonUI() {
            ...
            public void paint(Graphics g, JComponent c) {
                ...
                // Background fill (with hover effect)
                ...
                // White border (inside the rounded area)
                g2.setColor(Color.WHITE);
                g2.setStroke(new BasicStroke(2)); // 2px border
                g2.drawRoundRect(1, 1, c.getWidth() - 3, c.getHeight() - 3, 20, 20);
