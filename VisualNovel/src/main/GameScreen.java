...
public class GameScreen extends JFrame {
    ...
    public void showChoicesPanel(List<Choice> choices) {
        ...
        // let ChoicePanel tell us how tall it wants to be
        Dimension pref = choicePanel.getPreferredSize();
        int panelWidth  = 440;             // 400px button + 2×20px padding
        int panelHeight = pref.height + 40; // add some vertical padding

        int x = (getWidth()  - panelWidth)  / 2;  // center horizontally
        int y = (getHeight() - panelHeight) / 2;  // center vertically

        choicePanel.setBounds(x, y, panelWidth, panelHeight);
